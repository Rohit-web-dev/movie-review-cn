  ...
  return (
    <div className="details-page">
      <div className="banner relative">
        <img className="w-full h-96 object-cover" src="https://image.tmdb.org/t/p/w500/q6y0Go1tsGEsmtFryDOJo3dEmqu.jpg" alt="banner img" />
      ...
      <div className="movie-details p-16">
        <div className="mt-12 flex flex-col lg:flex-row gap-12">
          <div className="flex-1 flex items-stretch">
            <img className="w-auto object-cover rounded" src='https://image.tmdb.org/t/p/w500/q6y0Go1tsGEsmtFryDOJo3dEmqu.jpg' alt="movie img" />
          </div>
          <div className="flex-1 flex flex-col justify-between">
            <div>
              <h2 className="text-3xl font-bold mb-4">The Shawshank Redemption</h2>
